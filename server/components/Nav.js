...
export default function Nav ({show}) {
    ...
    const activeLink = inactiveLink+' text-[#2713bd] bg-white rounded-l-lg';
    ...
    return (
        <aside className={(show?'left-0':'-left-full')+" text-white top-0 p-4 pr-0 fixed w-full bg-[#2713bd] h-full md:static md:w-auto transition-all"}>
            ...
            <nav className="flex flex-col gap-2">
                ...
                <button 
                 className="flex gap-1 p-2 hover:text-[#bd6513] hover:bg-white rounded-l-lg"
                 onClick={logOut}
                 >
